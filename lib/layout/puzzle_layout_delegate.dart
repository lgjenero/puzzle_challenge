...
abstract class PuzzleLayoutDelegate extends Equatable {
  ...
  /// A widget builder for the status section of the puzzle based on
  /// the puzzle [state].
  ///
  ...
  /// A widget builder for the joystick section of the puzzle based on
  /// the puzzle [state].
  ///
  /// This section corresponds to:
  /// - the left side of the puzzle UI (to the left of the puzzle board)
  /// in landscape orientation.
  /// - the bottom side of the puzzle UI (above the puzzle board)
  /// in portrait orientation.
