...
abstract class PuzzleColors {
  ...
  /// Purple primary
  static const Color purplePrimary = Color(0xFF3F2832);

  /// Purple 90
  static const Color purple90 = Color(0xFF7B645A);

  /// Blue White
  static const Color blueWhite = Color(0xFF97A7AC);

  /// Light purple
  static const Color lightPurple = Color(0xFF8F5F82);

  /// Light purple
  static const Color darkPurple = Color(0xFF1C111E);

  /// Light purple
  static const Color midPurple = Color(0xFF503341);

  /// Light purple
  static const Color semiDarkPurple = Color(0xFF372831);
  ...
  /// Teal
  static const Color teal = Color(0xFF6AC9F5);
}
